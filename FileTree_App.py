...
st.write("At the time, running this App will open a window, a browser tab, and a terminal that will show error messages if needed. On a future release I will use another method. Thank you" )